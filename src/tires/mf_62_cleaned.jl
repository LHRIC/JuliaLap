...
function base(params::Dict{String, Any}, data::Dict{String, Any}, vx, vy, fz, alpha, kappa, gamma, omega)
    ...
    lmux = p["LMUX"]                                    # Scale factor of Fx peak friction coefficient
    lmuy = p["LMUY"]                                    # Scale factor of Fy peak friction coefficient
    lmuv = p["LMUV"]                                    # Not in tire model: slip speed Vs decaying friction
